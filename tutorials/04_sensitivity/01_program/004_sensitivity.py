...
# ===================    
for wave, typ, mode, freqs, dlogvadlogz, dlogvadlogvp, dlogvadlogvs, dlogvadlogrh in sker_gen:
    ...
    if not norm:
        ...
        for _ in dlogvadlogz, dlogvadlogvp, dlogvadlogvs, dlogvadlogrh:
            _[-1, :] = np.nan
    ...
    for M, p, q in zip([dlogvadlogz, dlogvadlogvp, dlogvadlogvs, dlogvadlogrh],
                       ["ln Z^{top}_i", r"ln Vp_i", "ln Vs_i", r"ln \rho _i"],
                       ["lnZtop", "lnVp", "lnVs", "lnrho"]):
